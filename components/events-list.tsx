  ...
  if (!data.eventCollection) {
    return <Empty>
      <EmptyHeader>
        ...
        <EmptyDescription>
          We&apos;re between events at the moment. New sessions and programs are being planned, so check back soon or join our mailing list for updates.
        </EmptyDescription>
      </EmptyHeader>
    </Empty>
  }
