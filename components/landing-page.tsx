    ...
    <div className="min-h-screen">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-semibold text-center mb-12 text-primary">Why choose Transcendental Meditation®</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2 md:pl-12">
              ...
              <p>Join us in our serene, cozy studio and discover the transformative power of meditation for your personal and professional growth.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <form className="max-w-md mx-auto">
            <div className="flex gap-4">
              ...
              <Button className="bg-emerald-800 hover:bg-emerald-700 dark:bg-emerald-50 dark:hover:bg-emerald-100 font-semibold">Get Started</Button>
            </div>
          </form>
        </div>
      </section>
